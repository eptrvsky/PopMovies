 ...
 */
public class PopmovieFragment extends Fragment implements AdapterView.OnItemClickListener{
    ...
    private void updatePopmovie() {
        ...
        new FetchMovieTask().execute(location);
    }
    /**
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mPopmovieAdapter = new ArrayAdapter<String>(getActivity(),
        ...
        forecastList.setAdapter(mPopmovieAdapter);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        String forecast = mPopmovieAdapter.getItem(position);
    ...
    private class FetchMovieTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... params) {
            ...
            final String BASE_URL_PARAM = "http://image.tmdb.org/t/p/w185//nBNZadXqJSdt05SHLqgT0HuC5Gm.jpg?";
...
//            String val_units_type = "metric";
        ...
        protected void onPostExecute(String[] strings) {
            if (strings != null && strings.length > 0) {
                mPopmovieAdapter.clear();
                for (String dayForecast : strings)
                    mPopmovieAdapter.add(dayForecast);
            }
